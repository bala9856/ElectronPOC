...
export class HomePage {
  ...
  constructor(page: Page) {
    ...
    this.User_Management = page.locator(
      '//button[@role="tab" and contains(text(),"User Management")]'
    );
    ...
    this.crName = page
      .locator(`//tbody//tr//td//div[text()='${testData.userplayWright.username}']`)
      .last();
    ...
    this.gender = page.locator(
      `//input[(@type='radio')and(@value='${testData.userplayWright.gender}')]`
    );
