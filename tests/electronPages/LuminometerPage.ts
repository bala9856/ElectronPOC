...
export class Luminometer {
  ...
  constructor(page: Page) {
    ...
    this.btnconnect = page.locator(
      "//h6[text()='Device Status']/parent::div/child::div//button[text()='Connect']"
    );
    this.devicedet = page.locator(
      "//h6[text()='Device Status']/parent::div//div[@class='MuiBox-root css-0']"
    );
    this.btnReconect = page.locator(
      "//h6[text()='Device Status']/parent::div/child::div//button[text()='Reconnect']"
    );
    this.currentdetails = page.locator(
      "//h6[text()='Current Data']/parent::div/following-sibling::div[@class='MuiBox-root css-0']"
    );
